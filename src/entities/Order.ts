...
export class Order {
    ...
    /**
     * The shipping details are copied onto the order rather than only
     * referenced, so an order stays accurate even if the customer later edits
     * or deletes the saved address it came from.
     */
    ...
    // Only the last four digits are ever stored. The full number is never
