...
/**
 * The option IDs offered on one vehicle.
 */
...
/**
 * Every option a vehicle offers, joined to its category so the service can
 * group the response the way the configurator page needs it.
 */
